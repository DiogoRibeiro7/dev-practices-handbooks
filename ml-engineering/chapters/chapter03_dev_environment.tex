...
\begin{tikzpicture}[node distance=2.5cm, auto,
    ...
    decision/.style={diamond, draw, fill=yellow!20, text width=2cm, text centered, minimum height=1.5cm},
    data/.style={cylinder, draw, fill=green!20, text width=2cm, text centered, minimum height=1cm, aspect=0.3},
...
\begin{itemize}
    ...
    \item \textbf{BigQuery ML Case Study}: End-to-end ARIMA\_PLUS forecasting pipeline
...
\begin{itemize}
    \item Train ARIMA\_PLUS models on time series data

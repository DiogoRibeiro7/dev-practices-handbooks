...
\centering
\begin{tikzpicture}[node distance=2.5cm, auto]
    \tikzstyle{source} = [rectangle, rounded corners, draw, fill=blue!20, text width=2.6cm, text centered, minimum height=1cm]
    \tikzstyle{stream} = [rectangle, draw, fill=purple!20, text width=2.4cm, text centered, minimum height=1cm]
    \tikzstyle{process} = [rectangle, draw, fill=green!20, text width=2.4cm, text centered, minimum height=1cm]
...
\begin{tikzpicture}[node distance=2.5cm]
    ...
    \node[draw, rectangle, fill=green!20, text width=2.6cm, text centered, right of=source1, node distance=3.5cm] (transform1) {Transform\\(ETL Job)};
    ...
    \node[draw, rectangle, fill=green!20, text width=2.6cm, text centered, right of=warehouse2, node distance=3.5cm] (transform2) {Transform\\(SQL/DBT)};
...
\begin{lstlisting}[style=yaml, caption=DVC pipeline configuration (dvc.yaml)]

...
\begin{itemize}
    ...
    \item \textbf{Value of gained capacity}: 4.48 FTE $	imes$ \$220K = \$985K
...
\begin{itemize}
    ...
    \item Random seeds not fixed: model results varied $pm$2.3\% across runs
...
\begin{itemize}
    \item Initial: \$320K
    \item Ongoing: \$95K/year $	imes$ 5 years = \$475K
    \item Total: \$795K
\end{itemize}

\textbf{Value Creation}:
\begin{itemize}
    \item Reproducibility: \$112K $	imes$ 5 = \$560K
    \item Reliability: \$1.2M $	imes$ 5 = \$6M
    \item Monitoring: \$400K $	imes$ 5 = \$2M
    \item Compliance: \$1.2M $	imes$ 5 = \$6M
...
\begin{enumerate}
    ...
    \item For each improvement, estimate:
        \begin{itemize}
            \item Initial implementation cost (engineer-weeks $	imes$ rate)
...
\begin{enumerate}
    ...
    \item Identify the pillar with highest leverage (improvement $	imes$ business impact)
...
\begin{enumerate}
    \item Assess current team capabilities across pillars:
        \begin{itemize}
            \item Create skill matrix (team members $	imes$ pillar skills)

...
\begin{itemize}
    ...
    \item Penalty: \$1,000 per violation + attorney fees (500,000 applications $	imes$ \$1,000 = \$500M potential exposure)
\end{itemize}
...
\begin{itemize}
    ...
    \item No intersectional fairness testing (race $	imes$ income $	imes$ geography)
...
\begin{itemize}
    \item Test fairness across race $	imes$ gender $	imes$ income intersections

...
\begin{itemize}
    \item \textbf{Dynamic wizards} mirror the templates from Chapters~\ref{ch:data-informed-tickets}, \ref{sec:experiment-design}, and \ref{sec:documentation-patterns}. JSON schema forms render sections (problem statement, hypotheses, metrics, acceptance criteria, risks, stakeholders) with autosave and validation.
